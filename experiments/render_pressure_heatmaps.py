...
from compare_v1_v3_drivaer import TransolverV1, SyntheticDrivAerML, train_and_evaluate
...
def main():
    ...
    fig.suptitle("Pressure Heatmap Comparison: Ground Truth vs v1 vs v3", fontsize=15, fontweight="bold", y=1.01)
